    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIWorkoutPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIWorkoutPlans_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerService", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIWorkoutPlans_AppUserId",
                table: "AIWorkoutPlans",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerService_TrainerId",
                table: "TrainerService",
                column: "TrainerId");
        }
